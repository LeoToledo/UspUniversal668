...
class FirstWindowWidget(QTW.QWidget):
    ...
    def init_ui(self):
        ...
        self.open_dir_btn = QTW.QPushButton('Abrir dir')
        ...
        self.open_dir_btn(self.open_directory)
...
class MainWindow(QTW.QMainWindow):
    ...
    def init_ui(self):
        ...
        self.import_widget = ExecuteWidget(self) #widget to import and run another .py program
...
class ExecuteWidget(QTW.QWidget):
    ...
    def init_ui(self):
        ...
        self.opn_dir_btn = QTW.QPushButton('Abrir dir')
